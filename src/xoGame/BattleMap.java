...
//        System.out.println("e.getButton() "+e.getButton());
    ...
    private void drawX(Graphics g, int cellX, int cellY) {
        ...
        g.drawLine(cellX * cellWidth+30, cellY * cellHeight+30,
                (cellX + 1) * cellWidth-40, (cellY + 1) * cellHeight-40);
        g.drawLine(cellX * cellWidth+120, cellY * cellHeight+30,
                (cellX + 1) * cellWidth-140, (cellY + 1) * cellHeight-40);
    ...
    private void drawO(Graphics g, int cellX, int cellY) {
        ...
        g.drawOval(cellX * cellWidth+20, cellY * cellHeight+20,
